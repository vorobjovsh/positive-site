...
$(document).ready(function() { // Ждём загрузки страницы
	...
	$("a.next").click(function(){	// Событие клика на ссылку "Продолжить"
			...
			function changeSkidka() { 
				 ...
				 if (razvorot_format == '2020' || razvorot_format == '2030') {
				 ...
				 if (razvorot_format == '2020' && razvorot_n == '1' && current_step == '3' || razvorot_format == '2020' && razvorot_n == '2' && current_step == '3') {
			          price = 0;
                  };
				 ...
				 if (razvorot_format == '2020' && razvorot_n == '1' && current_step == '2' || razvorot_format == '2020' && razvorot_n == '2' && current_step == '2') {
				 ...
				 if (razvorot_format == '3020' && razvorot_n == '1' && kol == '1'){
					 var sum = '3900';
				 } ;
				 ...
				 var temat = $("input[name=rrz]:checked").attr('data-tematika');
	             if (temat == 'scool'){
			         $("#scool_shablons").show();
					 $("#sadik_shablons").hide();
					 $("#vuz_shablons").hide();
					 $("#des1").attr("checked", true);
			      };
				 if (temat == 'sadik'){
			         $("#scool_shablons").hide();
					 $("#sadik_shablons").show(); 
					 $("#vuz_shablons").hide();
					 $("#des9").attr("checked", true);
			      };
				 if (temat == 'vuz'){
			         $("#scool_shablons").hide();
					 $("#sadik_shablons").hide();
					 $("#vuz_shablons").show();
					 $("#des12").attr("checked", true);
			      };
...
$(document).ready(function() {
	...
	$('.item_popup_new_ch1').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_ch2').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_u1').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_u2').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_u3').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_u4').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_u5').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
	...
	$('.item_popup_new_u6').magnificPopup({
		type:'image',
		alignTop: true,
        closeOnContentClick: true,
        closeBtnInside: false,
